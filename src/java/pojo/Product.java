...
public class Product  implements java.io.Serializable {
    ...
    public Product(Units units, String name, Double currentStock, Double currentPrice, Set discounts, Set grnLogs, Set diliveryItemLogs, Set invoiceLogs, Set vehicleStocks, Set diliveryLoads) {
       this.units = units;
       this.name = name;
